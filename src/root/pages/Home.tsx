...
function Home() {
    ...
    return (
        <div className="w-full center flex-col">
            ...
            {/* hero section */}
            <section className="hero w-full h-[450px] md:h-[500px] center flex-col gap-4">
            ...
            {/* showcase section */}
            <section className="w-full center flex-col gap-4 pt-24 text-text">
            ...
            {/* contact info */}
            <section className="w-full center flex-col gap-4 py-24">
                <ContactInfo />
            </section>
        </div>
    )
